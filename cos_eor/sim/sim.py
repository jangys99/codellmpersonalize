...
from habitat.utils.geometry_utils import (quaternion_from_coeff, quaternion_from_two_vectors)
...
from cos_eor.sim.actions import raycast
from cos_eor.utils.geometry import geodesic_distance, euclidean_distance, \
...
class CosRearrangementSim(HabitatSim):
    ...
    def init_metadata_objects_same_scene(self, task, episode):
        scene_name = os.path.basename(self.habitat_config.SCENE).split(".")[0]
        metadata_dir = os.path.dirname(self.habitat_config.SCENE)
