...
from cos_eor.dataset.dataset import CosRearrangementEpisode
import habitat_sim
import shortuuid
import magnum as mn
from cos_eor.scripts.igib_assemble_obj import urdf_to_obj, URDF_OBJ_CACHE
from cos_eor.utils.shelf_bin_packer import ShelfBinPacker
from cos_eor.utils.geometry import get_bb, get_bb_base, euclidean_distance, get_corners
from cos_eor.task.utils import get_packer_mapping
from cos_eor.scripts.build_utils import aggregate_amt_annotations
...
class CosRearrangementTask(NavigationTask):
    ...
    def _initialize_episode_objects(self, episode):
        ...
        for _, (file, key, pos, rot, cat) in enumerate(zip(episode.objs_files[start_idx:], episode.objs_keys[start_idx:],
    ...
    def _initialize_objects(self, episode: CosRearrangementEpisode):
        ...
        if self._sim.same_scene and self.instance_id_count > 1:
            ...
            # swap scene objects + receptacles
